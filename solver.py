...
from model import SylvesterFactorVAE1
...
class Solver(object):
    def __init__(self, args):
        ...
        if args.dataset == 'dsprites':
            ...
            self.VAE = SylvesterFactorVAE1(arg).to(self.device)
        ...
        self.win_id = dict(D_z='win_D_z', recon='win_recon',
                           kld='win_kld', acc='win_acc')
        self.line_gather = DataGather(
            'iter', 'soft_D_z', 'soft_D_z_pperm', 'recon', 'kld', 'acc')
